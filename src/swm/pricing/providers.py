...
GPU_SPECS: dict[str, GpuSpec] = {
    ...
    "h100": GpuSpec(
        ...
        bf16_tflops=989,
        fp8_tflops=1979,
        generation_seconds={"480p": 35, "720p": 70, "1080p": 140},
    ),
    "a100": GpuSpec(
        name="NVIDIA A100 80GB",
        vram_gb=80,
        mem_bandwidth_tbs=2.0,
        bf16_tflops=312,
        fp8_tflops=624,
        generation_seconds={"480p": 55, "720p": 110, "1080p": 220},
    ),
    "rtx4090": GpuSpec(
        ...
        bf16_tflops=165,
        fp8_tflops=330,
        generation_seconds={"480p": 90, "720p": 180, "1080p": 360},
    ),
    "l40s": GpuSpec(
        name="NVIDIA L40S",
        vram_gb=48,
        mem_bandwidth_tbs=0.864,
        bf16_tflops=362,
        fp8_tflops=724,
        generation_seconds={"480p": 70, "720p": 140, "1080p": 280},
    ),
}
...
OFFERINGS: list[GpuOffering] = [
    ...
    # ── Single-GPU: H100 / A100 / RTX 4090 / L40S (reference) ───────
    GpuOffering(
        provider="RunPod",
        gpu="h100",
        on_demand=2.69,
        ...
        security=("SOC 2 Type II", "HIPAA", "GDPR"),
        stop_resume=True,
        notes="Secure Cloud tier; verify live pricing with swm gpus",
    ),
    GpuOffering(
        provider="Vast.ai",
        gpu="h100",
        on_demand=2.10,
        estimated=True,
        notes="Marketplace pricing varies; verify live with swm gpus",
    ),
    GpuOffering(
        provider="Lambda",
        gpu="h100",
        ...
        estimated=True,
        security=("SOC 2 Type II",),
        notes="Reference rate; verify availability",
    ),
    GpuOffering(
        provider="RunPod",
        gpu="a100",
        ...
        security=("SOC 2 Type II", "HIPAA", "GDPR"),
        stop_resume=True,
        notes="80GB PCIe/SXM varies; verify live pricing",
    ),
    GpuOffering(
        provider="Vast.ai",
        gpu="a100",
        on_demand=0.80,
        estimated=True,
        notes="Marketplace pricing varies",
    ),
    GpuOffering(
        provider="RunPod",
        gpu="rtx4090",
        ...
        estimated=True,
        stop_resume=True,
        notes="Consumer GPU; verify live pricing",
    ),
    GpuOffering(
        provider="Vast.ai",
        gpu="rtx4090",
    ...
    GpuOffering(
        ...
        estimated=True,
        stop_resume=True,
        notes="Reference rate; verify live pricing",
    ),
]

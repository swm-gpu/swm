...
Change it with::
    ...
    swm models set <id> meta-llama/Llama-3.3-70B-Instruct

HuggingFace weights are cached in ``/workspace/vllm/hf_cache`` so they
persist across B2 syncs.
...
FRAMEWORK = Framework(
    ...
    steps=[
        Step(
            ...
            command=f"mkdir -p {_INSTALL_DIR} {_HF_CACHE}",
    ...
    post_install=[
        ...
        Step(
            ...
            command=(
                ...
                f"echo \"Change model: swm models set <id> <model>\""
            ),
        ),
    ],
    pre_start=[
